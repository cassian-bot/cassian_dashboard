defmodule CassianDashboardWeb.CommandsController do
  ...
  def index(conn, %{"provider" => provider}) when real_provider(provider) do
    ...
    render(conn, "index.html", provider: provider, playlists: get_playlist(conn, provider |> String.to_atom()))
  end
  ...
  """
  @spec get_playlist(conn :: %Plug.Conn{}, provider :: :spotify | any()) :: [%{name: String.t(), link: String.t()}]
