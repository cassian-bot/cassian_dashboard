defmodule CassianDashboardWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: CassianDashboardWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/cassian_dashboard_web/templates",
        namespace: CassianDashboardWeb
  ...
  defp view_helpers do
    quote do
      ...
      import CassianDashboardWeb.ErrorHelpers
      import CassianDashboardWeb.Gettext
      alias CassianDashboardWeb.Router.Helpers, as: Routes
    end
  end
